...
const getAllProduct=async(req,res,next)=>{
    ...
    try{        
        ...
        const productDetails=await Product.find(query).sort({"updatedAt":-1}).skip((pageNumber-1) * (sizeNumber)).limit(sizeNumber);
...
module.exports={createProduct,updateProduct,deleteProduct,getAllProduct,getOneProduct};